...
eval_loader = DataLoader(ev_set, batch_size=batch_size, shuffle=True, num_workers=8)
train_loader = DataLoader(tr_set, batch_size=batch_size, shuffle=True, num_workers=8)
