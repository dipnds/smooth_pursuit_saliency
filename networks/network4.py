...
class Net(nn.Module):
    def __init__(self):
        ...
        self.lstm1 = ConvLSTM(input_size=(9, 16), input_dim=512, hidden_dim=[512], kernel_size=(3, 3), num_layers=1, batch_first=True)
        self.lstm2 = ConvLSTM(input_size=(9, 16), input_dim=512, hidden_dim=[512], kernel_size=(3, 3), num_layers=1, batch_first=True)
        ...
        self.up = nn.Sequential(
                ...
                nn.Conv2d(16, 2, 3, padding=1, bias=True),
                nn.BatchNorm2d(2),
